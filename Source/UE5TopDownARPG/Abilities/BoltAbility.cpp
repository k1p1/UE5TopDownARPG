...
bool UBoltAbility::Activate(FVector AimLocation)
{
	...
	{
		UE_LOG(LogUE5TopDownARPG, Error, TEXT("UBoltAbility::Activate IsValid(World) == false"));
	}
	...
	{
		UE_LOG(LogUE5TopDownARPG, Error, TEXT("UBoltAbility::Activate IsValid(Projectile) == false"));
		return false;
	}
	return true;
}
